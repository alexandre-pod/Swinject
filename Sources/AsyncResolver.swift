...
// NOTICE:
//
// AsyncResolver.swift is generated from AsyncResolver.erb by ERB.
// Do NOT modify AsyncContainer.Arguments.swift directly.
// Instead, modify AsyncResolver.erb and run `script/gencode` at the project root directory to generate the code.
//


public protocol AsyncResolver {
    /// Retrieves the instance with the specified service type.
    ///
    /// - Parameter serviceType: The service type to resolve.
    ///
    /// - Returns: The resolved service type instance, or nil if no service is found.
    func resolve<Service>(_ serviceType: Service.Type) async -> Service?
    ...
    func resolve<Service>(_ serviceType: Service.Type, name: String?) async -> Service?
