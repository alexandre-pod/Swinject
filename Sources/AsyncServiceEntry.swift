...
internal protocol AsyncServiceEntryProtocol: AnyObject {
...
public final class AsyncServiceEntry<Service>: AsyncServiceEntryProtocol {
    ...
    internal weak var container: AsyncContainer?
